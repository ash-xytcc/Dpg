...
export default function NotePreview({ content, onOpenLink, focusMode, onUpdateProperty, onAddProperty, onRemoveProperty, propertiesCollapsed, onToggleProperties, onToggleTask }) {
  ...
  return (
    <div onClick={(e) => {
    ...
    }} style={{ maxWidth: 920, margin: "0 auto", background: dpg ? "var(--dpg-surface, #1a211e)" : "rgba(255,255,255,0.02)", border: dpg ? "1px solid var(--dpg-line, rgba(255,255,255,0.14))" : "1px solid #1f1f1f", color: dpg ? "var(--dpg-text, #f3efe8)" : "#f5f5f5", borderRadius: 10, padding: focusMode ? 12 : 10, minHeight: focusMode ? "84vh" : "72vh" }}>
      ...
      <style>{`.bf-note-preview{max-width:74ch;margin:0 auto;font-size:14px;line-height:1.62;color:${dpg ? "var(--dpg-text, #f3efe8)" : "#f5f5f5"}}.bf-note-preview h1,.bf-note-preview h2,.bf-note-preview h3,.bf-note-preview h4,.bf-note-preview h5,.bf-note-preview h6{margin:0 0 10px 0}.bf-note-preview p{margin:0 0 10px 0}.bf-note-preview ul,.bf-note-preview ol{margin:0 0 10px 0;padding-left:24px}.bf-note-preview li{margin:0 0 4px 0}.bf-note-preview blockquote{margin:0 0 10px 0;padding-left:12px;border-left:3px solid ${dpg ? "#5f94dd" : "#666"};color:${dpg ? "var(--dpg-muted, #b8c1cc)" : "#bbb"}}.bf-note-preview a[data-note-title], .bf-note-preview a[href]{color:${dpg ? "var(--dpg-accent-deep, #5f94dd)" : "#9ed0ff"};text-decoration:underline;cursor:pointer}.bf-note-preview code{background:${dpg ? "rgba(95,148,221,0.10)" : "rgba(255,255,255,0.08)"};padding:1px 4px;border-radius:4px}.bf-note-preview pre{background:${dpg ? "rgba(95,148,221,0.06)" : "rgba(255,255,255,0.05)"};padding:12px;border-radius:8px;overflow:auto;margin:0 0 10px 0}.bf-note-preview pre code{background:transparent;padding:0}.bf-note-preview hr{border:none;border-top:1px solid ${dpg ? "rgba(56,80,50,0.15)" : "rgba(255,255,255,0.15)"};margin:14px 0}.bf-note-preview .task-list-item{list-style:none;margin-left:-22px}.bf-note-preview .task-list-item input{margin-right:8px}`}</style>
